            ...
            <div className="block bg-white w-[360px] h-[363px] shadow-[0px_4px_67px_-12px_rgba(0,0,0,0.13)] mx-auto my-0 px-[60px] py-[50px] rounded-[30px] border-[0.7px] border-solid border-[#d4dbe5]">
              ...
              <div
               ...
               >
                ...
                <button
                  className="w-[280px] h-[52px] bg-[#BCEC30] flex items-center justify-center text-[18px] border none leading-[19.8px] font-normal tracking-[-0.14px] text-black mt-8 mb-2.5 rounded-[46px]
    outline: none hover:border none hover:bg-[#C6FF00] active:bg-[#000000] active:text-white border none"
                  id="btnEnter"
                  type="submit"
                >
                  Подтвердить
