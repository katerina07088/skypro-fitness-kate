...
export default function Register() {
            ...
            <div className="block bg-white w-[360px] h-[487] shadow-[0px_4px_67px_-12px_rgba(0,0,0,0.13)] mx-auto my-0 px-[60px] pt-[50px] pb-[35px] rounded-[30px] border-[0.7px] border-solid border-[#d4dbe5]">
              ...
              >
                <div className="gap-2.5">
                  <input
                    className="h-[52px] w-[280px] bg-white gap-2.5 px-[18px] py-4 rounded-lg border-[0.7px] border-solid border-[rgba(148,166,190,0.4)] first:mb-2.5 placeholder:font-normal placeholder:text-lg 
    ...
    outline: none hover:border-[none] hover:bg-[#C6FF00] active:bg-[#000000] active:text-white"
                ...
                <Link
                  className="h-[52px] w-[280px] text-[18px] border-solid border border-black text-black flex items-center justify-center bg-white rounded-[46px] hover:bg-[#F7F7F7] active:bg-[#E9ECED]"
                  id="btnEnter"
                  type="submit"
                  to={AppRoutes.LOGIN}
                >
